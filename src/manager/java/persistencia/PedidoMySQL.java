...
import manager.java.persistencia.BebidaMySQL;
import manager.java.persistencia.ConexaoMySQL;

public class PedidoMySQL implements PedidoDAO {

	@Override
	public Pedido selecionar(int id) throws ManagerException {
		...
		if (dados.size() > 0) {
			...
			throw new ManagerException("Pedido não cadastrada: " + id);
	}

	@Override
	public Pedido selecionar(String nome) throws ManagerException {
		ConexaoMySQL con = new ConexaoMySQL();
		...
		if (dados.size() > 0) {
			...
			throw new ManagerException("Pedido não cadastrado: " + nome);
	}

	@Override
	public Pedido getPedido(ArrayList<?> dados, int i) throws ManagerException {
		ConexaoMySQL con = new ConexaoMySQL();
		Pedido b = new Pedido();
	...
	@Override
	public ArrayList<Pedido> listar() throws ManagerException {
		ConexaoMySQL con = new ConexaoMySQL();
	...
	@Override
	public void adicionar(Pedido p) throws ManagerException {
		ConexaoMySQL con = new ConexaoMySQL();
	...
	@Override
	public void excluir(Pedido p) throws ManagerException {
		ConexaoMySQL con = new ConexaoMySQL();
