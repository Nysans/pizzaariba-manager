...
public class GerenteMySQL implements GerenteDAO {
	...
	@Override
	public Gerente selecionar(String user) throws ManagerException {
		...
		if (!dados.isEmpty()) {
			...
			throw new ManagerException("User Inválido");
		}
	}

	private Gerente getGerente(ArrayList<ArrayList<String>> dados, int i) throws ManagerException {
	...
	@Override
	public void adicionar(Gerente g) throws ManagerException {
		ConexaoMySQL con = new ConexaoMySQL();
	...
	@Override
	public ArrayList<String> listarUsers() throws ManagerException {
		ConexaoMySQL con = new ConexaoMySQL();
