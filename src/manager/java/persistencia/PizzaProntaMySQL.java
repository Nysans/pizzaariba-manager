...
public class PizzaProntaMySQL implements PizzaProntaDAO {
	...
	@Override
	public PizzaPronta selecionar(int id) throws ManagerException {
		...
		if (dados.size() > 0) {
			...
			throw new ManagerException("Pizza não cadastrada: " + id);
	}

	@Override
	public PizzaPronta selecionar(String nome) throws ManagerException {
		ConexaoMySQL con = new ConexaoMySQL();
		...
		if (dados.size() > 0) {
			...
			throw new ManagerException("Pizza não cadastrada: " + nome);
	}

	@Override
	public PizzaPronta getPizza(ArrayList<?> dados, int i) throws ManagerException {
		ConexaoMySQL con = new ConexaoMySQL();
	...
	@Override
	public ArrayList<PizzaPronta> listar() throws ManagerException {
		ConexaoMySQL con = new ConexaoMySQL();
	...
	@Override
	public void adicionar(PizzaPronta p) throws ManagerException {

	}

	@Override
	public void excluir(PizzaPronta p) throws ManagerException {
